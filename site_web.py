    ...
    for url in list(set(urls)):
        ...
        if benef >= SEUIL_BENEF:
            ...
            if not any(d.get('lien') == url for d in data):
                cat = {1492568836787142706:"Pokémon", 1492086204303413248:"Lego", 1492088431524843601:"Vêtements", 1492089160503132281:"Sneakers", 1492485336474058835:"Électronique"}.get(message.channel.id, "Divers")
